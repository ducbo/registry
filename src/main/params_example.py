...
#--- Database Backups
DBBACKUP_STORAGE_OPTIONS = {'location': '/opt'}
...
# BRUTE_FORCE_PROTECTION_DOMAIN_TRANSFER_KEY_PREFIX = 'domain_transfer_brute_force'
# BRUTE_FORCE_PROTECTION_DOMAIN_TRANSFER_MAX_ATTEMPTS = 15
# BRUTE_FORCE_PROTECTION_DOMAIN_TRANSFER_TIMEOUT = 60*15
...
ZENAIDA_REGISTRAR_ID = 'admin'
ZENAIDA_SUPPORTED_ZONES = 'cu.al'

ZENAIDA_RABBITMQ_CLIENT_CREDENTIALS_FILENAME = '/home/zenaida/keys/rabbitmq_client_conf.json'
...
ZENAIDA_DOMAIN_PRICE = 0.0
ZENAIDA_DOMAIN_RESTORE_PRICE = 0.0
